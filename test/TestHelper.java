...
class TestHelper {
	...
	private final Integer[] easy = {	0, 4, 3, 0, 0, 0, 6, 7, 0, 0, 0, 0, 2, 9, 3, 0, 0, 4, 2, 8, 0, 0, 0, 0, 3, 1, 9, 0,
										9, 0, 6, 0, 0, 0, 0, 0, 1, 0, 0, 5, 0, 7, 0, 0, 8, 0, 0, 0, 0, 0, 4, 0, 0, 0, 0,
										5, 6, 0, 0, 0, 0, 4, 1, 3, 0, 9, 4, 5, 2, 0, 0, 0, 0, 2, 7, 0, 0, 0, 9, 5, 0 };

	private final Integer[] easySolution = {	9, 4, 3, 1, 8, 5, 6, 7, 2, 6, 7, 1, 2, 9, 3, 5, 8, 4, 2, 8, 5, 7, 4, 6, 3,
												1, 9, 7, 9, 4, 6, 2, 8, 1, 3, 5, 1, 6, 2, 5, 3, 7, 4, 9, 8, 5, 3, 8, 9,
												1, 4, 7, 2, 6, 8, 5, 6, 3, 7, 9, 2, 4, 1, 3, 1, 9, 4, 5, 2, 8, 6, 7, 4,
												2, 7, 8, 6, 1, 9, 5, 3 };

	private final Integer[] medium = {	0, 8, 0, 0, 0, 4, 5, 6, 0, 0, 6, 0, 0, 0, 0, 0, 1, 7, 9, 0, 0, 0, 7, 0, 0, 8, 2,
										0, 0, 0, 7, 0, 0, 6, 0, 0, 0, 0, 5, 1, 0, 6, 7, 0, 0, 0, 0, 7, 0, 0, 3, 0, 0, 0,
										5, 1, 0, 0, 2, 0, 0, 0, 6, 3, 2, 0, 0, 0, 0, 0, 4, 0, 0, 7, 6, 4, 0, 0, 0, 9,
										0 };
	private final Integer[] hard = {	5, 0, 0, 0, 0, 0, 0, 3, 6, 0, 0, 8, 0, 7, 0, 0, 0, 0, 0, 1, 4, 0, 0, 5, 0, 0, 0, 9,
										0, 0, 6, 0, 0, 0, 0, 0, 4, 0, 0, 0, 8, 0, 1, 5, 0, 1, 0, 0, 0, 0, 2, 0, 0, 7, 8,
										4, 0, 1, 0, 0, 9, 0, 0, 7, 0, 0, 0, 4, 0, 8, 0, 0, 2, 3, 0, 0, 0, 0, 0, 0, 0 };
	private final Integer[] hardSolution = {	5, 9, 7, 8, 2, 1, 4, 3, 6, 3, 2, 8, 4, 7, 6, 5, 9, 1, 6, 1, 4, 3, 9, 5, 2,
												7, 8, 9, 7, 5, 6, 1, 4, 3, 8, 2, 4, 6, 2, 7, 8, 3, 1, 5, 9, 1, 8, 3, 9,
												5, 2, 6, 4, 7, 8, 4, 6, 1, 3, 7, 9, 2, 5, 7, 5, 1, 2, 4, 9, 8, 6, 3, 2,
												3, 9, 5, 6, 8, 7, 1, 4 };
	private final Integer[] hard2 = {	8, 0, 0, 1, 0, 0, 0, 0, 6, 0, 0, 2, 0, 0, 9, 0, 0, 4, 3, 0, 0, 0, 0, 6, 2, 5, 0,
										0, 2, 5, 0, 0, 0, 0, 0, 0, 4, 0, 0, 0, 1, 0, 0, 0, 3, 0, 0, 0, 0, 0, 0, 1, 6, 0,
										0, 4, 1, 3, 0, 0, 0, 0, 7, 5, 0, 0, 8, 0, 0, 4, 0, 0, 9, 0, 0, 0, 0, 4, 0, 0,
										1 };
	private Integer[] mediumSolution = {	7, 8, 1, 2, 3, 4, 5, 6, 9, 4, 6, 2, 9, 5, 8, 3, 1, 7, 9, 5, 3, 6, 7, 1, 4, 8,
											2, 1, 3, 8, 7, 9, 2, 6, 5, 4, 2, 9, 5, 1, 4, 6, 7, 3, 8, 6, 4, 7, 5, 8, 3,
											9, 2, 1, 5, 1, 4, 3, 2, 9, 8, 7, 6, 3, 2, 9, 8, 6, 7, 1, 4, 5, 8, 7, 6, 4,
											1, 5, 2, 9, 3 };
