...
import sudoku_new.visualizer.SWTVisualizer;
...
//		SudokuGenerator sg = new SudokuGenerator("Random Sudoku Generator");
        ...
        try {
            Sudoku sudoku = new Sudoku("Sudoku", easy);

            SWTVisualizer swtVisualizer = new SWTVisualizer(sudoku);

            Solver bruteForceSolver = new BruteForceSolver(sudoku);
            bruteForceSolver.addVisualizer(swtVisualizer);
            bruteForceSolver.addVisualizer(new ConsoleVisualizer(sudoku));
            swtVisualizer.addSolver(bruteForceSolver);
            bruteForceSolver.solve();

            Solver smartSolver = new SmartSolver(sudoku);
            smartSolver.addVisualizer(swtVisualizer);
            smartSolver.addVisualizer(new ConsoleVisualizer(sudoku));
            swtVisualizer.addSolver(smartSolver);
            smartSolver.solve();
